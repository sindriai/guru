...
// ─────────────────────────────────────────────────────────────────────────────
// homeworkGridBackgroundScrolling
// ─────────────────────────────────────────────────────────────────────────────

fun Modifier.homeworkGridBackgroundScrolling(
    listState: LazyListState,
    cellSize: Dp = 22.dp,
    lineColor: Color = Color(0xFF8FAADC),
    lineAlpha: Float = 0.25f
): Modifier = this.then(
    Modifier.drawBehind {
        val step   = cellSize.toPx()
        val shiftY = -(listState.firstVisibleItemScrollOffset % step)
